...
const
  ...
  UnitCopyright = '(c) 1999-2003 David J Butler';
...
type
  ...
  public
    ...
    function  AppendArray(const V: AArray): Integer; virtual; abstract;
  end;
...
type
  ...
  public
    ...
    function  AppendArray(const V: AArray): Integer; reintroduce; overload; override;
    ...
    function  AppendItem(const Value: LongInt): Integer; reintroduce; overload; virtual;
    function  AppendArray(const V: LongIntArray): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    ...
    function  AppendItem(const Value: LongWord): Integer; reintroduce; overload; virtual;
    function  AppendArray(const V: LongWordArray): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    ...
    function  AppendItem(const Value: Int64): Integer; reintroduce; overload; virtual;
    function  AppendArray(const V: Int64Array): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    ...
    function  AppendItem(const Value: Single): Integer; reintroduce; overload; virtual;
    function  AppendArray(const V: SingleArray): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    ...
    function  AppendItem(const Value: Double): Integer; reintroduce; overload; virtual;
    function  AppendArray(const V: DoubleArray): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    ...
    function  AppendItem(const Value: Extended): Integer; reintroduce; overload; virtual;
    function  AppendArray(const V: ExtendedArray): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    ...
    function  AppendItem(const Value: Pointer): Integer; reintroduce; overload; virtual;
    function  AppendArray(const V: PointerArray): Integer; reintroduce; overload; virtual;
    function  PosNext(const Find: Pointer; const PrevPos: Integer = -1): Integer; 
  end;
...
type
  ...
  public
    ...
    function  AppendItem(const Value: String): Integer; reintroduce; overload; virtual;
    function  AppendArray(const V: StringArray): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    ...
    function  AppendArray(const V: ObjectArray): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    ...
    function  IsEqual(const V: TObject): Boolean; override;
    function  AppendItem(const Value: Boolean): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    constructor Create(const V: LongIntArray = nil); reintroduce; overload;
...
type
  ...
  public
    constructor Create(const V: LongWordArray = nil); reintroduce; overload;
...
type
  ...
  public
    constructor Create(const V: Int64Array = nil); reintroduce; overload;
...
type
  ...
  public
    constructor Create(const V: SingleArray = nil); reintroduce; overload;
...
type
  ...
  public
    constructor Create(const V: DoubleArray = nil); reintroduce; overload;
...
type
  ...
  public
    constructor Create(const V: ExtendedArray = nil); reintroduce; overload;
...
begin
  if V is AObjectArray then
    ...
    Result := inherited AppendArray(V);
end;
...
begin
  ...
  For I := 0 to Length(FLookup[LookupList]) - 1 do
    if StrPEqual(ValueStrPtr, ValueStrLen, FData[FLookup[LookupList][I]], FCaseSensitive) then
      begin
        LookupIdx := I;
        Result := True;
        exit;
