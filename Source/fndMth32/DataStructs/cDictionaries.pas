...
type
  ...
  protected
    ...
    procedure DuplicateKeyError(const Key: String);
...
procedure ADictionary.DuplicateKeyError(const Key: String);
begin
  DictionaryError('Duplicate key: ' + Key);
end;
  ...
  if L > 0 then
    begin
      ...
      For I := 0 to Length(FLookup[H]) - 1 do
        begin
          J := FLookup[H, I];
          if StrPEqual(Pointer(Key), K, FKeys[J], FCaseSensitive) then
            begin
              Result := J;
              exit;
            end;
...
procedure TGeneralLongIntDictionary.IndexError;
begin
        ...
        begin
          ...
          For I := 0 to P^ - 1 do
            begin
              Inc(P);
              Result := P^;
              if StrPEqual(Pointer(Key), K, TStringArray(FKeys).Data[Result],
                  FCaseSensitive) then
                exit;
            end;
        end;
...
procedure TGeneralLongWordDictionary.IndexError;
begin
  DictionaryError('Index out of range');
end;
...
procedure TGeneralInt64Dictionary.IndexError;
begin
  DictionaryError('Index out of range');
end;
...
procedure TGeneralSingleDictionary.IndexError;
begin
  DictionaryError('Index out of range');
end;
...
procedure TGeneralDoubleDictionary.IndexError;
begin
  DictionaryError('Index out of range');
end;
...
procedure TGeneralExtendedDictionary.IndexError;
begin
  DictionaryError('Index out of range');
end;
...
procedure TGeneralStringDictionary.IndexError;
begin
  DictionaryError('Index out of range');
end;
...
procedure TGeneralObjectDictionary.IndexError;
begin
  DictionaryError('Index out of range');
end;
